...
- [ ] Implement font-organizer scan command
- [ ] Implement font-organizer organize command
- [ ] Implement font-organizer analyze command
- [ ] Implement font-organizer subset command
- [ ] Implement font-organizer duplicate command
- [ ] Implement font-organizer info command
- [ ] Implement font-organizer config command
...
### 5.3 MkDocs Site
- [ ] Create documentation structure in src_docs
